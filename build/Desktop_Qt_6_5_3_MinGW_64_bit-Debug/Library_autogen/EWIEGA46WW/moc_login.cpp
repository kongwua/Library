...
Q_CONSTINIT static const qt_meta_stringdata_CLASSloginENDCLASS_t qt_meta_stringdata_CLASSloginENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(6, 13),  // "login_success"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 10)   // "user_login"
    },
    "login",
    "login_success",
    "",
...
void login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (login::*)();
            if (_t _q_method = &login::login_success; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
